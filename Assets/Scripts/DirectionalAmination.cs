...
[CreateAssetMenu(fileName = "DirectionalAnimation", menuName = "Lost/DirectionalAnimation")]
public class DirectionalAmination : ScriptableObject
{
    ...
    public Vector2 GetClosestDirection(Vector2 inputDirection)
    {
        ...
        Vector2[] directionsToCheck = new Vector2[4] {
